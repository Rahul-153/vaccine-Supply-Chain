...
contract SupplyChain {
    ...
    uint256 public verCtr = 0;
    uint256 public issCtr = 0;
    ...
    mapping(uint256 => verifier) public VER;
    ...
    mapping(uint256 => issuer) public ISS;
    ...
    function addVerifier(
        ...
        verCtr++;
        VER[verCtr] = verifier(_address, verCtr, _name, _phone);
    }
    ...
    function addIssuer(
        ...
        issCtr++;
        ISS[issCtr] = issuer(_address, issCtr, _name, _phone);
    }
